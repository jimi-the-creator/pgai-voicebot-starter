...
1. A scenario is selected, such as `s03` for rescheduling an appointment.
2. The Python agent joins a LiveKit room.
3. LiveKit places an outbound SIP call to the assessment phone number.
4. The OpenAI Realtime model speaks as a realistic patient.
5. The medical-office AI responds over the phone.
6. The session is recorded and transcribed.
7. The transcript and recording are reviewed for bugs or quality issues.

## Final Evidence

### Recordings

Folder: `calls/final_recordings/`
...
Folder: `calls/final_transcripts/`
